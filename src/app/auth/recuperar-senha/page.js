...
function ForgotPasswordForm() {
  ...
  if (success) {
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center space-y-4 text-center animate-fade-in px-4">
        <div className="rounded-full bg-green-100 p-4">
          <CheckCircle className="size-14 text-green-600" />
        </div>
        <h2 className="font-serif text-2xl font-bold text-gray-900">{successMessage}</h2>
  ...
  return (
    <div className="w-full max-w-md space-y-8 animate-fade-in px-4 sm:px-0">
      ...
      <div className="text-center">
        <Link href="/auth/login" className="text-sm font-semibold text-primary transition-colors hover:text-primary/80 hover:underline">
          Voltar para o login
        </Link>
      </div>
    </div>
          ...
          <div className="flex-1 flex flex-col justify-center -mt-10">
            <div className="max-w-lg space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-white backdrop-blur-sm">
                ...
                <span className="text-xs font-medium uppercase tracking-wider">Suporte 24/7</span>
              </div>
              ...
              <h2 className="text-balance font-serif text-3xl font-bold leading-tight tracking-tight text-white drop-shadow-lg sm:text-4xl xl:text-5xl">
                ...
                <span className="text-white/95">à sua conta</span>
              </h2>
